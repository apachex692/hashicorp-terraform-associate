...
1. **List Workspaces:**
    - `terraform workspace list`: Lists all existing workspaces in the current configuration.
2. **Create a Workspace:**
    - `terraform workspace new <workspace_name>`: Creates a new workspace with the specified name.
3. **Switch Workspaces:**
