...
All operators supported in a general programming language are supported in HCL too.

## Loops

`for` loops can be used in HCL to apply transformation to data types as follows:

1. **Uppercase Each String in a List**
    1. **Result as a Tuple**
